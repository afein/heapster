...
func NewStatStore(epsilon uint64, resolution time.Duration, windowDuration uint16, supportedPercentiles []float64) *StatStore {
	return &StatStore{
		buffer:               list.New(),
		epsilon:              epsilon,
...
func (ss *StatStore) newBucket(numRes uint16) {
