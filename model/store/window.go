...
// the moving window
func (m *MovingWindow) PushBack(v hourEntry) {
...
// make a copy.
func (m *MovingWindow) Slice() []hourEntry {
...
// NewWindow creates a new moving window,
